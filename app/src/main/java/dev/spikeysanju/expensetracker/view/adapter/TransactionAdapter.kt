package dev.db.expensetracker.view.adapter
...
import dev.db.expensetracker.databinding.ItemTransactionLayoutBinding
        ...
        holder.binding.apply {
            ...
            when (item.transactionType) {
                "Income" -> {
                    ...
                    transactionAmount.text = "+ ".plus(formatCurrency(item.amount))
                }
                "Expense" -> {
                    transactionAmount.setTextColor(
                        ContextCompat.getColor(
