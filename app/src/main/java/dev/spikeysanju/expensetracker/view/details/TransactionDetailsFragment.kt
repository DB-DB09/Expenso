package dev.db.expensetracker.view.details
...
import dev.db.expensetracker.databinding.FragmentTransactionDetailsBinding
import dev.db.expensetracker.model.Transaction
import dev.db.expensetracker.utils.saveBitmap
...
class TransactionDetailsFragment : BaseFragment<FragmentTransactionDetailsBinding, TransactionViewModel>() {
    ...
    private fun onDetailsLoaded(transaction: Transaction) = with(binding.transactionDetails) {
        ...
        amount.text = formatCurrency(transaction.amount).cleanTextContent
